...
import { getCategoryProducts } from "../../network/APIs";
        ...
        <ShopContent>
          <ShopContentFilter>
            ...
            <ShopContentFilters>
              ...
              <Link href={`/shops/laptops`}>laptops</Link>
              <Link href={`/shops/motorcycle`}>motorcycle</Link>
              <Link href={`/shops/automotive`}>automotive</Link>
              <Link href={`/shops/sunglasses`}>sunglasses</Link>
            </ShopContentFilters>
          </ShopContentFilter>
          <ShopContentProducts>
